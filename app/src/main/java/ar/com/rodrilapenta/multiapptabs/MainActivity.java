...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webInstanceRepository.addWebInstance(new WebInstance("Google", "Sitio web de Google", "https://www.google.com.ar"));

        mRecyclerView = (RecyclerView) findViewById(R.id.recyclerWebInstances);
        ...
        mAdapter = new WebInstancesListAdapter(webInstanceRepository.getWebInstances(), wb);
    ...
    public void fillGoogleDataOnNavHeader(NavigationView navigationView) {
        ...
        new ImageLoadTask(userData.get("userGooglePhotoUrl"), (ImageView) headerLayout.findViewById(R.id.googleUserImage));
    }
